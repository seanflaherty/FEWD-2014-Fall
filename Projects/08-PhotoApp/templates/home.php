<section class="intro row">
  ...
  <section class="features row">
    <div class="desktop-4">
      <h2 class="features-title tag">Tag It All</h2>
      <p class="features-text">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam suscipit aliquet felis, quis.
        <p>
    </div>
    <div class="desktop-4">
      <h2 class="features-title cloud">Cloud Sync</h2>
      <p class="features-text">Epsum factorial non deposit quid pro quo hic escorol. Olypian quarrels et gorilla congolium sic ad nauseum.
        <p>
    </div>
    <div class="desktop-4">
      <h2 class="features-title photo">Photo Map</h2>
      <p class="features-text">Aenean eu leo quam. Pellentesque ornare sem lacinia quam venenatis vestibulum. Ligula porta felis.
      </p>
    </div>
  </section>
